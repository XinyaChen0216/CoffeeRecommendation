...
public class PersonsDao {
	...
	public Persons create(Persons person) throws SQLException {
		String insertPerson = "INSERT INTO Persons(UserName,UserPassword,Email,PhoneNumber) VALUES(?,?,?,?);";
		...
		try {
			...
			insertStmt.setString(2, person.getUserPassword());
			insertStmt.setString(3, person.getEmail());
			insertStmt.setString(4, person.getPhoneNumber());
	 ...
	 */
	public Persons updatePhoneNumber(Persons person, String newPhoneNumber) throws SQLException {
	...
	public Persons getPersonFromUserName(String userName) throws SQLException {
		String selectPerson = "SELECT UserName,UserPassword,Email,PhoneNumber FROM Persons WHERE UserName=?;";
		Connection connection = null;
		...
		try {
			...
			if(results.next()) {
				...
				Persons person = new Persons(resultUserName, userPassword, email, phoneNumber);
				return person;
			}
		} catch (SQLException e) {
			e.printStackTrace();
